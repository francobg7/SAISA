...
const ServicesPage: React.FC = () => {
  ...
  return (
        <div className="min-h-screen bg-cover bg-center bg-no-repeat pt-20" style={{ backgroundImage: 'url(/main/ex1.png)' }}>
          ...
          <div className="grid md:grid-cols-2 gap-12">
            {services.map((service, index) => {
              ...
              return (
                ...
                >
                  <div 
                    className={`relative overflow-hidden rounded-2xl transition-all duration-500 group-hover:shadow-2xl ${
